...
The AL unit provides a cross-plataform OpenAL interface.

Version History
   15/7/06  • First version
            • Removed alut support, not needed
   17/7/06  • Fixed bug with missing functions
            • Converted ALtypes to default Pascal types
   14/8/06  • Fixed more missing functions
   18/1/07  • Added support for some OpenAL extensions
              • Including audio capture extension
   10/7/07  • Added fallback stub functions if OpenAL is not installed
}
