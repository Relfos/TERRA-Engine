 ...
 **********************************************************************************************************************
 * TERRA_X
 * Implements Microsoft DirectX model loader (Windows only)
 ***********************************************************************************************************************
}
Unit TERRA_X; 
...
{$I terra.inc}
Interface
Uses Windows, DXTypes, Direct3D9, D3DX9, DXErr9, TERRA_Utils, TERRA_Vector3D, TERRA_Vector2D;
...
Type
  ...
  DXMesh = Class
    ...
    Public
      ...
      Procedure BuildAtlas(Width,Height:Integer; Callback:ProgressCallBack=Nil);
...
Var
  MyCallback:ProgressCallBack = Nil;

Function UVAtlasCallback(PercentDone: Single; lpUserContext: Pointer): HRESULT; stdcall;
begin
  If Assigned(MyCallback) Then
    MyCallback('Unwrapping mesh', Trunc(100*PercentDone));
  Result:= S_OK;
end;

Procedure DXMesh.BuildAtlas(Width,Height:Integer; Callback:ProgressCallBack=Nil);
Var
  Result:HRESULT;
