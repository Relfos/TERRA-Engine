...
Uses {$IFDEF USEDEBUGUNIT}TERRA_Debug,{$ENDIF}
    ...
    TERRA_Color, TERRA_Matrix, TERRA_Shader;
...
Begin
  ...
  Begin
    ...
    M := MatrixMultiply4x4(M, GraphicsManager.Instance.ActiveViewport.Camera.Transform);
  ...
  MyShader := GraphicsManager.Instance.EnableColorShader(_Color, MatrixIdentity);
