...
Type
  ...
  OculusApplication = Class(Application)
    Protected
      ...
      _EyeBuffers:Array[0..1] Of RenderTargetInterface;
...
Procedure OculusApplication.InitBuffers;
Var
  cfg:ovrGLConfig;
  Caps:Cardinal;
  Eye:Integer;
...
Procedure OculusApplication.Release;
Var
  I:Integer;
Begin
...
Procedure OculusApplication.OnFrameBegin();
Begin
  If _HMD = Nil Then
    Exit;
...
Procedure OculusApplication.OnFrameEnd();
Var
  Eye:Integer;
...
Begin
  ...
  Begin
    ...
    Textures[Eye].TexId := OpenGLFBO(_EyeBuffers[Eye]).Handle;
  End;
...
Function OculusApplication.GetWidth: Word;
Begin
  If _HMD = Nil Then
    Self.InitHMD();
...
Function OculusApplication.GetHeight: Word;
Begin
  If Assigned(_HMD) Then
