...
Function TGAFormat.LoadFromStream(Target: TERRAObject; Source: TERRAStream): Boolean;
Var
  Header:TGAHeader;
  ColorDepth:Cardinal;
...
Function TGAFormat.SaveToStream(Target:TERRAObject; Dest:TERRAStream):Boolean;
Var
  I,J:Integer;
  Header:TGAHeader;
  Color:ColorRGBA;
