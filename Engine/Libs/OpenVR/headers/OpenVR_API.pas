...
//
// Purpose: This file contains Delphi bindings for the OpenVR interfaces
//
//=============================================================================
...
Type
  VR_HmdError = Cardinal;

Const
	VR_Error_None = 0;
	VR_Error_Unknown = 1;
	VR_Error_Init_InstallationNotFound = 100;
	VR_Error_Init_InstallationCorrupt = 101;
	VR_Error_Init_VRClientDLLNotFound = 102;
	VR_Error_Init_FileNotFound = 103;
	VR_Error_Init_FactoryNotFound = 104;
	VR_Error_Init_InterfaceNotFound = 105;
	VR_Error_Init_InvalidInterface = 106;
	VR_Error_Init_UserConfigDirectoryInvalid = 107;
	VR_Error_Init_HmdNotFound = 108;
	VR_Error_Init_NotInitialized = 109;
	VR_Error_Init_PathRegistryNotFound = 110;
	VR_Error_Init_NoConfigPath = 111;
	VR_Error_Init_NoLogPath = 112;
	VR_Error_Init_PathRegistryNotWritable = 113;
	VR_Error_Driver_Failed = 200;
	VR_Error_Driver_Unknown = 201;
	VR_Error_Driver_HmdUnknown = 202;
	VR_Error_Driver_NotLoaded = 203;
	VR_Error_Driver_RuntimeOutOfDate = 204;
	VR_Error_Driver_HmdInUse = 205;
	VR_Error_IPC_ServerInitFailed = 300;
	VR_Error_IPC_ConnectFailed = 301;
	VR_Error_IPC_SharedStateInitFailed = 302;
	VR_Error_IPC_CompositorInitFailed = 303;
	VR_Error_IPC_MutexInitFailed = 304;
	VR_Error_VendorSpecific_UnableToConnectToOculusRuntime = 1000;
	VR_Error_Steam_SteamInstallationNotFound = 2000;


Function VR_Init(Out peError:VR_HmdError):Pointer; CDecl; External OpenVRLib Name 'VR_Init';
Procedure VR_Shutdown(); CDecl; External OpenVRLib Name 'VR_Shutdown';

Function VR_GetGenericInterface(pchInterfaceVersion:PChar; Out peError:VR_HmdError):Pointer; CDecl; External OpenVRLib Name 'VR_GetGenericInterface';
Function VR_IsHmdPresent():Boolean; CDecl; External OpenVRLib Name 'VR_IsHmdPresent';

Function VR_GetStringForHmdError(error:VR_HmdError):PAnsiChar; CDecl; External OpenVRLib  Name 'VR_GetStringForHmdError';
...
Type
  GraphicsAPIConvention = Cardinal;
...
Type
  HmdTrackingResult = Cardinal;

Const
	VR_TrackingResult_Uninitialized = 1;
	VR_TrackingResult_Calibrating_InProgress = 100;
	VR_TrackingResult_Calibrating_OutOfRange = 101;
	VR_TrackingResult_Running_OK = 200;
	VR_TrackingResult_Running_OutOfRange = 201;

Type
  TrackedDeviceClass = Cardinal;

Const
	VR_Tracking_Invalid = 0;
	VR_Tracking_HMD = 1;
	VR_Tracking_Controller = 2;
	VR_Tracking_TrackingReference = 4;
	VR_Tracking_Other = 1000;

Type
  TrackingUniverseOrigin = Cardinal;

Const
	VR_TrackingUniverseSeated = 0;
	VR_TrackingUniverseStanding = 1;
	VR_TrackingUniverseRawAndUncalibrated = 2;

Type
  TrackedDeviceProperty = Cardinal;
...
Type
  EVRControllerAxisType = Cardinal;
...
Type
  EVRControllerEventOutputType = Cardinal;
...
Type
  CameraImageResult = Cardinal;

Const
	VR_CameraImageResult_OK = 0;
	VR_CameraImageResult_Uninitalized = 1;
	VR_CameraImageResult_NotReady = 2;
	VR_CameraImageResult_SameFrame = 3;

Type
  ChaperoneCalibrationState = Cardinal;

Const
	VR_ChaperoneCalibrationState_OK = 1;
	VR_ChaperoneCalibrationState_Warning = 100;
	VR_ChaperoneCalibrationState_Warning_BaseStationMayHaveMoved = 101;
	VR_ChaperoneCalibrationState_Warning_BaseStationRemoved = 102;
	VR_ChaperoneCalibrationState_Warning_SeatedBoundsInvalid = 103;
	VR_ChaperoneCalibrationState_Error = 200;
	VR_ChaperoneCalibrationState_Error_BaseStationUninitalized = 201;
	VR_ChaperoneCalibrationState_Error_BaseStationConflict = 202;
	VR_ChaperoneCalibrationState_Error_SoftBoundsInvalid = 203;
	VR_ChaperoneCalibrationState_Error_HardBoundsInvalid = 204;

Type
  Compositor_DeviceType = Cardinal;

Const
  VR_Compositor_Device_None = 0;
	VR_Compositor_Device_D3D9 = 1;
	VR_Compositor_Device_D3D9Ex = 2;
	VR_Compositor_Device_D3D10 = 3;
	VR_Compositor_Device_D3D11 = 4;
	VR_Compositor_Device_OpenGL = 5;

Type
  VRCompositorError = Cardinal;
...
Type
  VROverlayInputMethod = Cardinal;

Const
	VROverlayInput_None = 0;
	VROverlayInput_Mouse = 1;

Type
  VROverlayVisibility = Cardinal;
...
Type
  VROverlayTransformType = Cardinal;
