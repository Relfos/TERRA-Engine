...
type
  ...
  published
    ...
    property Caption:TERRAString read FCaption write SetCaption;
...
procedure TPNGButton.SetCaption(const Value:TERRAString);
begin
  FCaption := Value;
  Repaint
end;
