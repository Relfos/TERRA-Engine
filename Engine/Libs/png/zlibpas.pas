...
type
  ...
  TZStreamRec = packed record
    next_in: PTERRAChar;       // next input byte
    avail_in: Integer;    // number of bytes available at next_in
    total_in: Integer;    // total nb of input bytes read so far

    next_out: PTERRAChar;      // next output byte should be put here
    avail_out: Integer;   // remaining free space at next_out
    total_out: Integer;   // total nb of bytes output so far

    msg: PTERRAChar;           // last error message, NULL if no error
...
function inflateInit_(var strm: TZStreamRec; version: PTERRAChar;
...
function deflateInit_(var strm: TZStreamRec; level: Integer; version: PTERRAChar;
  recsize: Integer): Integer; forward;
...
const
  ...
  _z_errmsg: array[0..9] of PTERRAChar = (
...
function adler32(adler: LongInt; const buf: PTERRAChar; len: Integer): LongInt; external;
