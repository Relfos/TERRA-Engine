...
Version History
 ...
 16/08/07   • Added support for FILE protocol, for reading local files
}
...
Const
  ...
  HTTPPort = 80;
  BufferSize = 1024;
  ClientName = 'TERRA Downloader v1.1';
...
Type
  ...
  HTTPDownloader = Class(TERRAObject)
    ...
    Public
      ...
      Constructor Create(URL:AnsiString; Dest:Stream; Callback:DownloadCallback = Nil; Port:Integer=HTTPPort); // Returns file size in bytes
  ...
  DownloadManager = Class(ApplicationComponent)
    ...
    Public
      ...
      Function Start(URL:AnsiString; Dest:Stream; Callback:DownloadCallback = Nil; UserData:Pointer = Nil; Port:Integer=HTTPPort):HTTPDownloader; Overload;
      Function Start(URL:AnsiString; Callback:DownloadCallback = Nil; UserData:Pointer = Nil; Port:Integer=HTTPPort; AllowCache:Boolean=True):HTTPDownloader; Overload;

      Function Post(URL:AnsiString; Port:Integer=HTTPPort):Integer;

      Function Put(URL:AnsiString; Source:Stream; Port:Integer=HTTPPort):Integer;
...
Constructor HTTPDownloader.Create(URL:AnsiString; Dest:Stream; Callback:DownloadCallback = Nil; Port:Integer=HTTPPort);
Var
  I:Integer;
  Request:AnsiString;
Begin
...
Function DownloadManager.Start(URL:AnsiString; Dest:Stream; Callback:DownloadCallback; UserData:Pointer; Port:Integer): HTTPDownloader;
Var
  Downloader :HTTPDownloader;
Begin
  Log(logError, 'HTTP', 'Starting download.');
  Downloader := HTTPDownloader.Create(URL, Dest, Callback, Port);
...
Function DownloadManager.Start(URL:AnsiString; Callback:DownloadCallback; UserData:Pointer; Port:Integer; AllowCache:Boolean): HTTPDownloader;
Var
...
Begin
  ...
  Result := Self.Start(URL, Dest, Callback, Userdata, Port);
End;
...
Function DownloadManager.Post(URL:AnsiString; Port: Integer): Integer;
Var
  I:Integer;
  Dest:Socket;
...
Function DownloadManager.Put(URL:AnsiString; Source: Stream; Port: Integer): Integer;
Var
  I:Integer;
  Dest:Socket;
  Len:Integer;
