...
Begin
  ...
  If Engine.Input.Keys.IsDown(keyLeft) Then
    Self.GUI.Viewport.Camera.Move(CameraMove_Left, CameraScrollSpeed);

  If Engine.Input.Keys.IsDown(keyRight) Then
    Self.GUI.Viewport.Camera.Move(CameraMove_Right, CameraScrollSpeed);

  If Engine.Input.Keys.IsDown(keyUp) Then
    Self.GUI.Viewport.Camera.Move(CameraMove_Up, CameraScrollSpeed);

  If Engine.Input.Keys.IsDown(keyDown) Then
    Self.GUI.Viewport.Camera.Move(CameraMove_Down, CameraScrollSpeed);

  If Engine.Input.Keys.IsDown(keySpace) Then
    Self.GUI.Viewport.Camera.Shake(500);
End;
