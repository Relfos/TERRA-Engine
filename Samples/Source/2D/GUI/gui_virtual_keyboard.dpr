...
Var
  Fnt:TERRAFont;
  MyWnd, MyEdit, MyKb, MyBtn, MyBtn2:UIWidget;
...
Begin
  ...
  UITemplates.AddTemplate(UIVirtualKeyboardTemplate.Create('kb_template', Engine.Textures.GetItem('ui_kb_bg'), 3, 3, 29, 29));


//  MyKb := UIInstancedWidget.Create('mykb', Self.GUI, UIPixels(0), UIPixels(0), 90, UIPercent(100), UIPercent(50), 'btn_template');
  //MyKb.Align := UIAlign_BottomLeft;
//  MyKb.Draggable := True;
